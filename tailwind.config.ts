      ...
      "accordion-up": {
        ...
        to: { height: "0" },
			...
			"accordion-down-md3-emphasized-1": {
				from: { height: "0" },
				to: { height: "calc(var(--radix-accordion-content-height) * 0.166666)" },
			},
			"accordion-down-md3-emphasized-2": {
				from: { height: "calc(var(--radix-accordion-content-height) * 0.166666)" },
				to: { height: "var(--radix-accordion-content-height)" },
			},
			"accordion-up-md3-emphasized-1": {
				from: { height: "var(--radix-accordion-content-height)" },
				to: { height: "calc(var(--radix-accordion-content-height) * 0.833334)" },
			},
			"accordion-up-md3-emphasized-2": {
				from: { height: "calc(var(--radix-accordion-content-height) * 0.833334)" },
				to: { height: "0" },
			}
    },
    animation: {
      ...
      "accordion-down-md3-emphasized":
				`accordion-down-md3-emphasized-1 0.066666s cubic-bezier(0.3, 0, 0.8, 0.15) 0s forwards,

  ...
  <>
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        'inline-flex items-center justify-center whitespace-nowrap rounded-lg px-4 py-1.5 text-label-medium-prominent ring-offset-background transition-all focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-state-layers-primary/12 data-[state=active]:shadow-xs',
